...
It is also impossible not to notice the big "Jolene" all over community 7 which must of course refer to Dolly Partons mega hit by the same name. If we investiage which community she belongs to, it is of course this exact one! You can try to play around with these communities yourself and find other cool terms and artists by downlading the network and following the instructions in the linked Ipython Notebook listed at the bottom.
`;
